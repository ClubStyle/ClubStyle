...
const MATERIALS_DATA: MaterialItem[] = [
  ...
  { id: '15', title: "Как собрать капсулу", hashtag: "#эфиры", image: "/ЭФИРЫ.png", link: "https://t.me/c/2055411531/1544", description: "Вчера состоялся наш закрытый эфир только для участниц Клуба на тему «Капсульный гардероб»! Я раскрыла выбранную вами тему и ответила на вопросы", video_link: "https://youtu.be/0n4m54NT7Lw" },
  ...
  { id: '19', title: "Эфир с Леной", hashtag: "#эфиры", image: "/ЭФИРЫ.png", link: "https://t.me/c/2055411531/4742", description: "Вчера состоялся наш закрытый эфир только для участниц Клуба, где я разбирала ваши праздничные образы❤️", video_link: "https://vimeo.com/1040450173" },
  { id: '20', title: "Эфир с диетологом", hashtag: "#эфиры", image: "/ЭФИРЫ.png", link: "https://t.me/c/2055411531/4847", description: "В субботу состоялся закрытый эфир с диетологом Анастасией Егоровой, на котором Анастасия рассказывала как подготовиться к новогоднему застолью 🥗", video_link: "https://vimeo.com/1041654053?share=copy#t=282.321" },
